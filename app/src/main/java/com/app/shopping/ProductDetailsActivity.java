...
public class ProductDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productName = (TextView) findViewById(R.id.textView11);
        productDescription = (TextView) findViewById(R.id.textView13);
        productPrice = (TextView) findViewById(R.id.textView12);
